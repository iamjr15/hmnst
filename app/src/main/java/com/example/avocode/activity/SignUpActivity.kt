...
class SignUpActivity : AppCompatActivity() {
        ...
        buttonSignUp.setOnClickListener {
            when {
                ...
                checkEmptyStrings(editTextPhone!!.text.toString()) -> {
                    ...
                    val docSnapshot = db!!.collection(Constants.USER_COLLECTION).document("+91" + editTextPhone!!.text.toString()).get()
    ...
    private fun addNewRegisteredUser() {
        ...
        intent.putExtra(getString(R.string.phone_label), editTextPhone!!.text.toString().trim { it <= ' ' })
